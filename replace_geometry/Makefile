...
SOURCES = \
	__init__.py \
	replace_geometry.py replace_geometry_dialog.py

PLUGINNAME = replace_geometry

PY_FILES = \
	__init__.py \
	replace_geometry.py replace_geometry_dialog.py

UI_FILES = replace_geometry_dialog_base.ui
...
QGISDIR=C:\Users\Valerio.Pinna\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
